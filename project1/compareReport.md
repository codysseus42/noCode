...
|비교항목 | Make | n8n | 
| --- | --- | --- |
| 1 UI/UX| 둘다 시각적 node 기반 사용성은 비슷하나 make가 비전문적인 작업에 조금더 편리 | 
| 2 설정난이도 | 동일한 기능에 한하여 make가 조금더 직관적이지만 n8n이 다건처리등 복잡한 기능 구현에는 더 간편함  | 
| 3 연동 서비스 범위 |둘다 광범위하나 make가 googleForm을 직접 제공하는 등 조금 더 많음 | 
